...
#newsconttitle h1{ font-size:14px; font-weight:bold; color:#666; padding:0; margin:0;;text-align:center;}
...
#articleHeader { margin:5px 0; padding:10px;background:#ECE1C6; height:60px;}
...
<div id="newscontent">
	<div id="newsconttitle">
		...
		<p><span style="float:right;">访问人次：<?php echo $data['counts']; ?></span><span><?php echo $data['dtTime']; ?>　来源: </span><a  href="<?php echo $data['sourceUrl']; ?>"><?php echo $data['source']; ?></a></p>
	</div>
    <div class="clear"></div>

...
#newlist li a{ background:url(<?php echo $tag['path.skin']; ?>res/images/200682320557934.gif) 6px 5px no-repeat; color:#999; padding:0 0 0 25px;}
#newlist li a:hover{ background:url(<?php echo $tag['path.skin']; ?>res/images/200682320557917.gif) 6px 5px no-repeat; color:#fc0;}

...
function maxHeight() {
	...
	console.log('header outer height: ' + h);

	var f = $('div[data-role="footer"]').outerHeight(true);
	
	console.log('footer outer height: ' + f);
	var w = $(window).height();
	console.log('window height: ' + w);
	
	var c = $('div[data-role="content"]');
	var c_h = c.height();
	console.log('content height: ' + c_h);
	var c_oh = c.outerHeight(true);
	console.log('content outer height: ' + c_oh);
	var c_new = w - h - f - c_oh + c_h;
	var total = h + f + c_oh;
	if (c_h < c.get(0).scrollHeight) {
		c.height(c.get(0).scrollHeight);
		console.log('height with scroll: ' + c.get(0).scrollHeight);
		return c.get(0).scrollHeight;
	} else {
		c.height(c_new);
		console.log('height without scroll: ' + c_new);
		return c_new;
	}
}
